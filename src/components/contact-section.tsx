...
export function ContactSection() {
  return (
    <div className="absolute bottom-16 left-0 right-0 z-40 px-6 container mx-auto">
      <div className="w-fit flex flex-col items-center gap-2 bg-[#0d1117]/80 backdrop-blur-md border border-[#38bdf8]/20 rounded-2xl px-4 py-3">
        ...
        <span className="font-mono font-bold text-sm text-foreground bg-[#38bdf8] rounded-md px-4 py-3 hover:cursor-pointer hover:bg-[#38bdf8]/80 transition-all duration-300">
        <a target="_blank" href={`mailto:${personalInfo.email}`}>
              INITIATE_CONTACT()
          </a>
        </span>
      </div>
